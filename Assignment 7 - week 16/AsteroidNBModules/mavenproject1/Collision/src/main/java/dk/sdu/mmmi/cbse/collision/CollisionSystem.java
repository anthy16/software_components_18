...
public class CollisionSystem implements IPostEntityProcessingService {
    ...
    public void process(GameData gd, World world) {
        for (Entity entity : world.getEntities()) {
            ...
            if (entity.getClass() == dk.sdu.mmmi.cbse.commonplayer.Player.class) {
                this.checkPlayerCollision(entity, x, y, world);
            } else if (entity.getClass() == dk.sdu.mmmi.cbse.commonasteroid.Asteroid.class) {
                this.checkAsteroidCollision(entity, x, y, world);
            } else if (entity.getClass() == dk.sdu.mmmi.cbse.commonenemy.Enemy.class) {
    ...
    *   @param  world   the game world
    ...
    private void checkPlayerCollision(Entity player, int entityX, int entityY, World world) {
        ...
        // Bullet check
        for (Entity bullet : world.getEntities(dk.sdu.mmmi.cbse.commonbullet.Bullet.class)) {
        ...
        //Asteroid check
        for (Entity asteroid : world.getEntities(dk.sdu.mmmi.cbse.commonasteroid.Asteroid.class)) {
