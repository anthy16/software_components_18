    ...
    public void process(GameData gameData, World world) {
        ...
        for (Entity player : world.getEntities(Player.class)) {
            ...
            if (gameData.getKeys().isDown(SPACE) && canShoot) {
                AnnotationConfigApplicationContext bulletContext = new AnnotationConfigApplicationContext(PlayerConfig.class);
                bulletService = bulletContext.getBean(BulletSPI.class);
